      ...
      >
        ...
        <div className="relative">
          ...
          <button
            ...
            className="mt-4 w-full py-3 rounded-xl bg-white/20 backdrop-blur-sm text-white text-sm font-semibold hover:bg-white/30 transition-colors flex items-center justify-center gap-2 group border border-white/20"
          >
            Оформить заказ
